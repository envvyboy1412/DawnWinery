...
import { cancelTransaction, getTransactionById } from "@/service/transaction.service";
...
function updateTransactionProof(arg0: { token: string; transactionId: string; imageUrl: string; }) {
