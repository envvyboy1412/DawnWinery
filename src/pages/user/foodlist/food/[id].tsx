...
import { getFoodDetail } from "@/service/food.service";
import { getFoodRatings, submitFoodRating } from "@/service/rating.service";
import { likeFood, unlikeFood } from "@/service/like.service";
import { addToCart, getCarts, updateCartQuantity } from "@/service/cart.service";
...
const handleToggleLike = async () => {
  ...
  try {
    ...
    const isLikedSekarang = food.isLike;
    ...
    setFood({ ...food, isLike: !isLikedSekarang });

    toast.success(
      !isLikedSekarang
        ? "Ditambahkan ke favorite ❤️"
        : "Dihapus dari favorite 🤍"
    );
  } catch (err: any) {
    toast.error(err?.message || "Gagal mengubah favorite");
  }
};
